        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            <div>
                <nav class="flex items-center gap-2 text-sm text-mist-400 mb-5"><a href="{{ route('home') }}"
                    ...
                    class="badge-blue"><flux:icon.dot-blue />Cloud &amp; Email</span>
                ...
                <p class="text-base text-mist-500 leading-relaxed max-w-md mb-8">Cloud email and Microsoft 365 or Google
                    Workspace should just work - and your team should never have to think about it. Code Wize handles
                    setup, migration, and ongoing management for Miami businesses.</p>
