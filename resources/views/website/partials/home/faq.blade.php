<section id="faq" class="bg-stone-50 py-20">
  <div class="mx-auto max-w-6xl px-6">
    <div class="grid grid-cols-1 gap-14 md:grid-cols-[2fr_3fr]">
      <div>
        <span class="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-3 py-1 text-xs font-bold tracking-widest text-blue-700 uppercase"><span class="h-1.5 w-1.5 rounded-full bg-blue-600"></span>FAQ</span>
      ...
      <div class="flex flex-col gap-2" x-data>
        <div x-data="{ open: false }" class="overflow-hidden rounded-xl border border-stone-100 bg-white">
          <button class="flex w-full items-center justify-between gap-4 px-5 py-4 text-left text-sm font-semibold text-stone-900 transition-colors hover:bg-stone-50" @click="open = !open" :aria-expanded="open.toString()"><span>What areas do you cover for on-site support?</span><span class="flex-shrink-0 text-xl leading-none text-blue-600 transition-transform duration-200" :class="open ? 'rotate-45' : ''">+</span></button>
        ...
        <div x-data="{ open: false }" class="overflow-hidden rounded-xl border border-stone-100 bg-white">
          <button class="flex w-full items-center justify-between gap-4 px-5 py-4 text-left text-sm font-semibold text-stone-900 transition-colors hover:bg-stone-50" @click="open = !open" :aria-expanded="open.toString()"><span>What kinds of businesses do you work with?</span><span class="flex-shrink-0 text-xl leading-none text-blue-600 transition-transform duration-200" :class="open ? 'rotate-45' : ''">+</span></button>
        ...
        <div x-data="{ open: false }" class="overflow-hidden rounded-xl border border-stone-100 bg-white">
          <button class="flex w-full items-center justify-between gap-4 px-5 py-4 text-left text-sm font-semibold text-stone-900 transition-colors hover:bg-stone-50" @click="open = !open" :aria-expanded="open.toString()"><span>What does IT support cost?</span><span class="flex-shrink-0 text-xl leading-none text-blue-600 transition-transform duration-200" :class="open ? 'rotate-45' : ''">+</span></button>
        ...
        <div x-data="{ open: false }" class="overflow-hidden rounded-xl border border-stone-100 bg-white">
          <button class="flex w-full items-center justify-between gap-4 px-5 py-4 text-left text-sm font-semibold text-stone-900 transition-colors hover:bg-stone-50" @click="open = !open" :aria-expanded="open.toString()"><span>What does a software project cost?</span><span class="flex-shrink-0 text-xl leading-none text-blue-600 transition-transform duration-200" :class="open ? 'rotate-45' : ''">+</span></button>
        ...
        <div x-data="{ open: false }" class="overflow-hidden rounded-xl border border-stone-100 bg-white">
          <button class="flex w-full items-center justify-between gap-4 px-5 py-4 text-left text-sm font-semibold text-stone-900 transition-colors hover:bg-stone-50" @click="open = !open" :aria-expanded="open.toString()"><span>Can we start with IT support and add software later?</span><span class="flex-shrink-0 text-xl leading-none text-blue-600 transition-transform duration-200" :class="open ? 'rotate-45' : ''">+</span></button>
        ...
        <div x-data="{ open: false }" class="overflow-hidden rounded-xl border border-stone-100 bg-white">
          <button class="flex w-full items-center justify-between gap-4 px-5 py-4 text-left text-sm font-semibold text-stone-900 transition-colors hover:bg-stone-50" @click="open = !open" :aria-expanded="open.toString()"><span>Do you work with businesses outside your three industries?</span><span class="flex-shrink-0 text-xl leading-none text-blue-600 transition-transform duration-200" :class="open ? 'rotate-45' : ''">+</span></button>
