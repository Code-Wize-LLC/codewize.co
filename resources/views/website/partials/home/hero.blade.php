<section class="bg-mist-50 pt-28 pb-4">
    <div class="mx-auto max-w-6xl px-6">
        <div class="grid grid-cols-1 items-center gap-14 md:grid-cols-2">
            <div class="pt-6">
                ...
                <h1 class="font-display mt-5 mb-6 text-5xl leading-tight font-bold tracking-tight text-mist-900 md:text-6xl">
                ...
                <p class="mb-8 max-w-lg leading-relaxed text-mist-500">Code Wize handles IT support for small and medium-sized organizations across Miami-Dade and South Broward - and builds the custom software your business needs when the generic tools stop working.</p>
        ...
        <div class="mt-8 grid grid-cols-2 overflow-hidden rounded-2xl border border-mist-100 md:grid-cols-4">
            <div class="border-r border-mist-100 bg-white px-6 py-7">
                <p class="text-4xl font-bold text-mist-900">10+</p>
                <p class="mt-1 text-xs font-medium text-mist-400">Years in Miami</p>
            </div>
            <div class="border-r border-mist-100 bg-white px-6 py-7">
                <p class="text-4xl font-bold text-mist-900">50+</p>
                <p class="mt-1 text-xs font-medium text-mist-400">Projects delivered</p>
            </div>
            <div class="border-r border-mist-100 bg-white px-6 py-7">
                <p class="text-4xl font-bold text-mist-900">24/7</p>
                <p class="mt-1 text-xs font-medium text-mist-400">Monitoring</p>
            </div>
            <div class="bg-white px-6 py-7">
                <p class="text-4xl font-bold text-mist-900">Fast</p>
                <p class="mt-1 text-xs font-medium text-mist-400">Response times</p>
            </div>
        </div>
    </div>
</section>
