<section class="bg-stone-50 pt-28 pb-4">
  <div class="mx-auto max-w-6xl px-6">
    <div class="grid grid-cols-1 items-start gap-14 md:grid-cols-2">
      <div class="pt-6">
        <span class="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-3 py-1 text-xs font-bold tracking-widest text-blue-700 uppercase"><span class="h-1.5 w-1.5 rounded-full bg-blue-600"></span>Miami-Dade &amp; South Broward</span>
        ...
        <p class="mb-8 max-w-lg text-lg leading-relaxed text-stone-500">Code Wize handles IT support for contractors, accountants, and insurance offices across Miami-Dade and South Broward — and builds the custom software your business needs when the generic tools stop working.</p>
        <div class="flex flex-wrap items-center gap-3">
          <a href="{{ route('it-support') }}" class="rounded-xl bg-stone-900 px-6 py-2.5 text-sm font-semibold text-stone-50 transition-colors hover:bg-blue-600"> Get IT Support &rarr; </a>
          <a href="{{ route('custom-software') }}" class="flex items-center gap-1 text-sm font-semibold text-stone-500 transition-colors hover:text-stone-900"> See the software side <span>&rarr;</span> </a>
        </div>
      </div>
      <div class="relative overflow-hidden rounded-2xl bg-stone-200" style="height:420px;">
        <img src="{{ asset('images/hero.jpg') }}" alt="IT support consultation" class="h-full w-full object-cover" />
        ...
        <div class="absolute right-5 bottom-5 left-5">
          <div class="flex items-center gap-3 rounded-xl bg-stone-50/95 p-4 backdrop-blur-md">
            <div class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-blue-600">
