    ...
    <div class="mx-auto max-w-6xl px-6">
        ...
        <div class="grid grid-cols-1 overflow-hidden rounded-2xl border border-stone-100 md:grid-cols-2">
            <div class="border-b border-stone-100 bg-white p-10 md:border-r md:border-b-0">
                <p class="mb-4 text-6xl leading-none font-bold text-stone-300 select-none">01</p>
                ...
                <h3 class="mt-4 mb-3 text-2xl font-display font-bold text-stone-900">IT Support &amp; Day-to-Day Tech</h3>
            ...
            <div class="bg-stone-100 p-10">
                ...
                <span class="badge-green">
                    <flux:icon.dot />The differentiator
                </span>
                <h3 class="mt-4 mb-3 text-2xl font-display font-bold text-stone-900">Custom Software &amp; Web Apps</h3>
