<section class="bg-stone-50 py-20">
  <div class="mx-auto max-w-6xl px-6">
    <div class="relative mb-10 overflow-hidden rounded-2xl bg-stone-800" style="height:260px;">
      <img src="{{ asset('images/team.jpg') }}" alt="Team" class="h-full w-full object-cover object-center opacity-60" />
    ...
    <div class="grid grid-cols-1 overflow-hidden rounded-2xl border border-stone-100 md:grid-cols-2">
      <div class="border-b border-stone-100 bg-white p-10 md:border-r md:border-b-0">
        ...
        <a href="{{ route('it-support') }}" class="mt-7 inline-block rounded-xl bg-stone-900 px-5 py-2.5 text-sm font-semibold text-stone-50 transition-colors hover:bg-blue-600">Get IT support &rarr;</a>
      </div>
      <div class="bg-stone-50 p-10">
        ...
        <a href="{{ route('custom-software') }}" class="mt-7 inline-flex items-center gap-1 text-sm font-semibold text-stone-500 transition-colors hover:text-stone-900">See what's been built <span>&rarr;</span></a>
      </div>
    </div>
  </div>
</section>
