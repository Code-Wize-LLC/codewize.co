<section class="py-20 bg-mist-50">
    <div class="max-w-6xl mx-auto px-6">
        <div class="relative bg-mist-900 rounded-3xl overflow-hidden text-center px-8 py-16">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">Let's get your technology sorted.</h2>
            <p class="text-mist-400 text-base max-w-md mx-auto mb-8 leading-relaxed">Free 30-minute call. We'll look
