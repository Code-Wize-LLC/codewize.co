        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            <div>
                ...
                <div class="relative flex gap-4 items-start pb-6 last:pb-0">
                    <div class="w-8 h-8 rounded-full bg-stone-900 text-white flex items-center justify-center text-sm font-bold shrink-0">4</div>
            ...
            <div>
                <div class="bg-stone-900 rounded-2xl p-8">
                    ...
                    <ul class="list-none flex flex-col gap-3 mb-7 pt-5 border-t border-white/10">
                        <li class="flex items-start gap-3 text-sm text-stone-300"><span class="text-blue-400 font-bold shrink-0 mt-0.5">&#10003;</span>One monthly number, agreed upfront</li>
                        <li class="flex items-start gap-3 text-sm text-stone-300"><span class="text-blue-400 font-bold shrink-0 mt-0.5">&#10003;</span>Unlimited remote support included</li>
                        <li class="flex items-start gap-3 text-sm text-stone-300"><span class="text-blue-400 font-bold shrink-0 mt-0.5">&#10003;</span>On-site visits included for Miami-Dade &amp; South Broward</li>
                        <li class="flex items-start gap-3 text-sm text-stone-300"><span class="text-blue-400 font-bold shrink-0 mt-0.5">&#10003;</span>24/7 monitoring included</li>
                        <li class="flex items-start gap-3 text-sm text-stone-300"><span class="text-blue-400 font-bold shrink-0 mt-0.5">&#10003;</span>No long-term contract required</li>
                    </ul>
