<section class="py-20 bg-mist-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            {{-- Custom Software --}}
            <a href="{{ route('custom-software') }}" class="group flex flex-col bg-white border border-mist-100 rounded-2xl p-6 hover:border-green-200 hover:-translate-y-1 hover:shadow-lg transition-all duration-200 no-underline">
            ...
            {{-- Web Applications --}}
            <a href="{{ route('web-apps') }}" class="group flex flex-col bg-white border border-mist-100 rounded-2xl p-6 hover:border-green-200 hover:-translate-y-1 hover:shadow-lg transition-all duration-200 no-underline">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-11 h-11 rounded-xl bg-green-50 flex items-center justify-center group-hover:bg-green-100 transition-colors">
                ...
                <h3 class="font-semibold text-mist-900 mb-2">Web Applications & Portals</h3>
                <p class="text-sm text-mist-500 leading-relaxed flex-1">Client-facing portals, online intake forms, scheduling tools, and business websites built for Miami-Dade local search.</p>
                <div class="mt-4 pt-4 border-t border-mist-100">
                    <p class="text-xs text-mist-400">Client portals · Intake forms · Scheduling · Business websites</p>
                </div>
            </a>

            {{-- Dashboards --}}
            <a href="{{ route('dashboards') }}" class="group flex flex-col bg-white border border-mist-100 rounded-2xl p-6 hover:border-green-200 hover:-translate-y-1 hover:shadow-lg transition-all duration-200 no-underline">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-11 h-11 rounded-xl bg-green-50 flex items-center justify-center group-hover:bg-green-100 transition-colors">
        ...
        {{-- Pricing callout --}}
        <div class="mt-6 bg-white rounded-2xl border border-mist-100 p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="flex gap-3 items-start">
                ...
                <div>
                    <p class="text-sm font-semibold text-mist-900 mb-1">Typical project ranges</p>
                    <p class="text-xs text-mist-500 leading-relaxed">Simple tools from $3K–$6K. Dashboards with integrations $5K–$12K. Full custom applications $10K+.</p>
                </div>
            </div>
            <div class="flex gap-3 items-start">
                <div class="w-8 h-8 rounded-full bg-green-50 flex items-center justify-center flex-shrink-0 mt-0.5">
