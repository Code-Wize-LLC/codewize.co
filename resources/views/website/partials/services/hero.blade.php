    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="bg-white rounded-2xl border border-mist-100 p-6 flex flex-col gap-3">
                    ...
                    <p class="text-xs text-mist-400 leading-relaxed">Remote & on-site support, monitoring, backups, and helpdesk</p>
                </div>
                <div class="bg-white rounded-2xl border border-mist-100 p-6 flex flex-col gap-3">
                    <div class="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                    ...
                    <p class="text-sm font-semibold text-mist-900">Network Security</p>
                    <p class="text-xs text-mist-400 leading-relaxed">Firewalls, WiFi, endpoint protection, and threat monitoring</p>
                </div>
                <div class="bg-white rounded-2xl border border-mist-100 p-6 flex flex-col gap-3">
                    <div class="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                    ...
                    <p class="text-sm font-semibold text-mist-900">Cloud & Email</p>
                    <p class="text-xs text-mist-400 leading-relaxed">M365 & Google Workspace setup, migration, and management</p>
                </div>
                <div class="bg-white rounded-2xl border border-mist-100 p-6 flex flex-col gap-3">
                    <div class="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                    ...
                    <p class="text-xs text-mist-400 leading-relaxed">Cloud phone systems for any device, any location</p>
                </div>
                <div class="bg-white rounded-2xl border border-mist-100 p-6 flex flex-col gap-3">
                    ...
                    <p class="text-xs text-mist-400 leading-relaxed">Portals, tools, and web apps built for your workflow</p>
                </div>
                <div class="bg-white rounded-2xl border border-mist-100 p-6 flex flex-col gap-3">
                    <div class="w-10 h-10 rounded-xl bg-green-50 flex items-center justify-center flex-shrink-0">
                    ...
                    <p class="text-xs text-mist-400 leading-relaxed">Live business intelligence from your existing tools</p>
                </div>
            </div>
        </div>
    </div>
