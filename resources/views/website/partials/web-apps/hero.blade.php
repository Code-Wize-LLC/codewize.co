    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            <div>
                ...
                <h1 class="mt-4 text-4xl md:text-5xl font-bold font-display text-mist-900 tracking-tight leading-tight mb-5">Custom Web Applications & Client Portals.<br><span class="text-blue-600 italic font-normal">Connect with clients. Simplify your work.</span></h1>
