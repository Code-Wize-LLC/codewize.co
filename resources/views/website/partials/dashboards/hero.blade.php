        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            <div>
                <nav class="flex items-center gap-2 text-sm text-mist-400 mb-5">
                    ...
                    <span>/</span>
                    <span class="text-mist-600">Dashboards</span>
                </nav>
                <span class="badge-green"><flux:icon.dot-green />Dashboards &amp; Reporting</span>
                ...
                <div class="flex flex-wrap gap-3 items-center">
                    <a href="{{ route('contact') }}" class="btn-primary">Get a free scoping call &rarr;</a>
                    <a href="{{ route('custom-software') }}" class="btn-secondary">See all software services</a>
                </div>
            </div>
            <div class="rounded-2xl overflow-hidden bg-mist-200 h-64 md:h-100">
                <img src="{{ asset('web/1981-digital-bf9sZBcGQl4-unsplash.webp') }}" alt="" class="w-full h-full object-cover">
            </div>
        </div>
    </div>
</section>
