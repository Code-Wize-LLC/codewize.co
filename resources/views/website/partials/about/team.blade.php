        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div class="group bg-mist-50 rounded-2xl border border-mist-100 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-xs font-semibold text-blue-600 uppercase tracking-widest mb-3">Founder &amp; Lead Engineer</p>
                    <p class="text-sm text-mist-500 leading-relaxed">Started Code Wize after years in enterprise IT. Responsible for all architecture decisions and key client relationships.</p>
                </div>
            </div>
            <div class="group bg-mist-50 rounded-2xl border border-mist-100 overflow-hidden">
                <div class="h-52 bg-mist-200 relative overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-xs font-semibold text-green-600 uppercase tracking-widest mb-3">Software Development Lead</p>
                    <p class="text-sm text-mist-500 leading-relaxed">Leads all custom software and web application projects. Works directly with clients through requirements, build, and launch.</p>
                </div>
            </div>
            <div class="group bg-mist-50 rounded-2xl border border-mist-100 overflow-hidden">
                <div class="h-52 bg-mist-200 relative overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-xs font-semibold text-blue-600 uppercase tracking-widest mb-3">IT Support &amp; Network</p>
                    <p class="text-sm text-mist-500 leading-relaxed">Handles day-to-day support, network builds, and on-site visits throughout Miami-Dade and South Broward.</p>
                </div>
            </div>
        </div>
    </div>
