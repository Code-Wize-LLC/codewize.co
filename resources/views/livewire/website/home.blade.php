<div>
    {{-- Hero Jumbotron --}}
    <div class="relative overflow-hidden px-4 sm:px-6 py-4 max-w-full mx-auto aspect-[9/12] md:aspect-video flex items-center justify-center">
        <!-- Background video -->
        ...
        <!-- Overlay -->
        <div class="absolute inset-0 bg-zinc-950/80 backdrop-blur-lg z-15"></div>
        ...
        <div class="z-20 text-center">
            <div class="max-w-full text-white">
                ...
                <h2 class="mt-6 md:text-xl max-w-4xl">{{ __("We empower businesses to operate smarter with dependable IT solutions, tailored software, and actionable data insights that drive growth.") }}</h2>
            </div>
        </div>
    </div>
    ...
    <div class="page-pattern">
        {{-- Trusted By --}}
        <div class="px-4 sm:px-6 py-12 space-y-12 max-w-7xl mx-auto w-full prose prose-invert text-center">
            ...
            <div class="grid justify-center grid-cols-2 gap-8 text-zinc-400 md:grid-cols-3">
                ...
                <a href="#" class="flex justify-center items-center">
                    <img src="{{ asset('logos/equitable.png') }}" alt="At Ease Logo" class="sm:h-20 object-fill opacity-80">
                </a>
                <a href="#" class="flex justify-center items-center">
                    <img src="{{ asset('logos/atease.webp') }}" alt="At Ease Logo" class="sm:h-20 object-fill opacity-80">
                </a>
                <a href="#" class="flex justify-center items-center">
                    <img src="{{ asset('logos/tpbs.webp') }}" alt="TPBS Logo" class="sm:h-20 object-fill opacity-80">
                </a>
                <a href="#" class="flex justify-center items-center">
                    <img src="{{ asset('logos/mjd.png') }}" alt="At Ease Logo" class="sm:h-20 object-fill opacity-80">
                </a>
            </div>
        </div>

        <div class="px-4 sm:px-6 py-12 sm:py-24 max-w-7xl mx-auto prose prose-invert">
        ...
        <div class="px-4 sm:px-6 py-12 sm:pt-24 max-w-7xl mx-auto">
            ...
            <div class="mt-12 sm:mt-24 border-l border-r border-accent/10 py-4">
                <div class="border-t -mx-4 border-accent/10"></div>
                <div class="py-6 text-center cta-pattern">
